import { Box, Button, Center, Group, Paper, Stack, Text, useMantineTheme } from "@mantine/core";
    ...
    <Box>
      <Stack mt="md">
        {fields.map((child, index) => (
          <Paper withBorder p="sm" bg={theme.fn.rgba(theme.fn.themeColor('grape'), 0.025)} sx={{ flex: 1  }} key={child.id}>
            <Box>
              <Text mb="sm" weight='bold'>and</Text>
              <EditRule
